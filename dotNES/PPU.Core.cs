...
namespace dotNES
{
    partial class PPU
    {
        //Establishing a game-width and a game-height to be used
        ...
        //proccessing pixels as well as background pixels to be displayed
        ...
        //method used to count the sprites on a given line
        ...
        {
            // NES Dev wiki can be thanked for this 
        ...
        //proccess the background pixels 
        ...
        private void ProcessSpritesForPixel(int x, int scanline)
        {
            for (int idx = _spriteCount * 4 - 4; idx >= 0; idx -= 4)
            {
                ...
                // to that of the Gameboy / Gameboy Color, so some code was sort of just copy/pasted
